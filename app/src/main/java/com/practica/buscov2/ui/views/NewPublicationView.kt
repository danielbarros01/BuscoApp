...
@Composable
fun NewPublicationView(navController: NavHostController) {
    Box(modifier = Modifier.fillMaxSize()) {
        NewPublication(Modifier.align(Alignment.Center), navController)
    }
}

@Composable
fun NewPublication(modifier: Modifier, navController: NavHostController) {
//Rutas de navegacion
